...
import { SpellingEngine } from '../../game/spelling/SpellingEngine'
...
export default function SpellingPage() {
  ...
  const engineRef = useRef<SpellingEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/spelling.json')
      .then(r => r.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new SpellingEngine(canvas, level)
