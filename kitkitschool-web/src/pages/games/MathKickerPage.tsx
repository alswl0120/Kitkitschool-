...
// Soccer field background - same theme as WordKicker
...
// Inject CSS keyframe animations (shared style ID differs from WordKicker)
function injectStyles() {
  const id = 'mathkicker-styles'
  if (document.getElementById(id)) return
  const style = document.createElement('style')
  style.id = id
  style.textContent = `
    @keyframes mkKickGoal {
    ...
    @keyframes mkChoicePop {
      0%   { transform: scale(0.8); opacity: 0; }
      100% { transform: scale(1); opacity: 1; }
    }
    @keyframes mkCelebrate {
...
export default function MathKickerPage() {
  ...
  const handleChoice = (choiceIdx: number) => {
    ...
    const chosen = currentProblem.choices[choiceIdx]
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {currentProblem.question} <span style={{ color: '#FFD700' }}>?</span>
          </div>
        </div>
        ...
        <div style={{
          ...
          {animState !== 'idle' && (
            <div style={{
              ...
              animation: animState === 'correct'
                ? 'mkKickGoal 1.2s ease-in forwards'
                : 'mkKickBlock 1.0s ease-out forwards',
            }}>
              ⚽
            </div>
          )}
          ...
          {animState === 'wrong' && (
            <div style={{
              ...
              transform: 'translateY(-50%)',
              fontSize: 40,
              animation: 'mkBlockShake 0.6s ease-in-out',
            }}>
              🧤
            </div>
          )}
          ...
          {animState === 'correct' && (
            <div style={{
              ...
              animation: 'mkGoalPop 0.5s ease-out forwards',
        ...
        {/* Choice buttons - wider to fit numbers */}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  animation: `mkChoicePop 0.3s ease-out ${idx * 60}ms both`,
                }}
              >
                {choice}
              </button>
      ...
      {showComplete && (
        <div style={{
          ...
          <div style={{
            animation: 'mkCelebrate 0.6s ease-out forwards',
            display: 'flex', flexDirection: 'column',
