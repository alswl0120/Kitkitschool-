...
import AnimalPuzzleEngine from '../../game/animalpuzzle/AnimalPuzzleEngine'
...
export default function AnimalPuzzlePage() {
  ...
  const engineRef = useRef<AnimalPuzzleEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/animalpuzzle.json')
      .then(r => r.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new AnimalPuzzleEngine(canvas, level)
