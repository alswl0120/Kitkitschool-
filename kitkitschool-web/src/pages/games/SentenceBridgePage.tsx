...
export default function SentenceBridgePage() {
  ...
  useEffect(() => {
    ...
    const engine = new SentenceBridgeEngine(canvas, level)
  ...
  if (level === 0) {
    return (
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', justifyContent: 'center', maxWidth: 700, padding: '0 20px' }}>
