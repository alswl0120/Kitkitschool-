...
import { FindTheMatchEngine } from '../../game/findthematch/FindTheMatchEngine'
import ProgressBar from '../../components/ProgressBar'
import BackButton from '../../components/BackButton'
import { useShellParams } from '../../hooks/useShellParams'

export default function FindTheMatchPage() {
  const navigate = useNavigate()
  const { shellLevel, isFromShell, onGameComplete, shellBack } = useShellParams()
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const engineRef = useRef<FindTheMatchEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/findthematch.json')
      .then(r => r.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new FindTheMatchEngine(canvas, level)
