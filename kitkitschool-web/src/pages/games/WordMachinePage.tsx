...
export default function WordMachinePage() {
  ...
  useEffect(() => {
    ...
    const engine = new WordMachineEngine(canvas, level)
    engineRef.current = engine
    ;(window as any).__wmEngine = engine
