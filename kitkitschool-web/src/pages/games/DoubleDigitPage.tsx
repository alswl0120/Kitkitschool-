...
import { DoubleDigitEngine } from '../../game/doubledigit/DoubleDigitEngine'
import ProgressBar from '../../components/ProgressBar'
import BackButton from '../../components/BackButton'
import { useShellParams } from '../../hooks/useShellParams'

export default function DoubleDigitPage() {
  const navigate = useNavigate()
  const { shellLevel, isFromShell, onGameComplete, shellBack } = useShellParams()
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const engineRef = useRef<DoubleDigitEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/doubledigit.json')
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new DoubleDigitEngine(canvas, level)
