...
import { NumberTraceEngine } from '../../game/numbertrace/NumberTraceEngine'
...
export default function NumberTracePage() {
  ...
  const engineRef = useRef<NumberTraceEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/numbertrace.json')
      .then(r => r.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new NumberTraceEngine(canvas, level)
