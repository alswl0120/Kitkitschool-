...
import { EquationMakerEngine } from '../../game/equationmaker/EquationMakerEngine'
import ProgressBar from '../../components/ProgressBar'
import BackButton from '../../components/BackButton'
import { useShellParams } from '../../hooks/useShellParams'

export default function EquationMakerPage() {
  const navigate = useNavigate()
  const { shellLevel, isFromShell, onGameComplete, shellBack } = useShellParams()
  const canvasRef = useRef<HTMLCanvasElement>(null)
  const engineRef = useRef<EquationMakerEngine | null>(null)
  ...
  useEffect(() => {
    fetch('/data/games/equationmaker.json')
      .then(res => res.json())
      .then(data => {
  ...
  useEffect(() => {
    ...
    const engine = new EquationMakerEngine(canvas, level)
